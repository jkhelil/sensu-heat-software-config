#!/usr/bin/perl -w
# isync::spico rovigo-bck fano-bck
# tsync::spezia-bck falerna-bck fiore-bck pianoro-bck pieve-bck rivalta-bck ragusa-bck amantea-bck cascina-bck cervia-bck gaeta-bck gaiole-bck faenza-bck    felice-bck    baia-bck barge-bck claviere-bck biella-bck marino-bck ombra-bck sona-bck punta-bck chtimi imola casole-bck ssezze scaserta smarettimo sromagna semilia erba-bck radda-bck dozza-bck riola-bck sbolzano orvieto-bck marsala-bck uvsclbh01-bck uvsclbh02-bck lucera-bck cecina-bck celano-bck firenze-bck frascati-bck bacoli-bck bassano-bck calimera-bck cannara-bck bagni-bck dorgali-bck mattinata-bck mazara-bck sabaudia-bck sannicola-bck serrara-bck sperlonga-bck silea-bck siracusa-bck uvsctut01 uvsctut02
# sync::rodigo-bck rezzato-bck villongo-bck volpiano-bck noci-bck nemi-bck praiano-bck pozzuoli-bck pellio-bck peccioli-bck budoni-bck bornio-bck ascoli-bck alassio-bck monteronni-bck molveno-bck letojanni-bck levico-bck gubbio-bck gaggi-bck ostuni-bck oliveto-bck noto-bck pianoro-bck todi-bck tempio-bck sestri-bck sasso-bck narni-bck duino-bck spoleto-bck dasso-bck mauro-bck pouilles-bck bonifacio-bck martino-bck paceco-bck palmi-bck rapallo-bck recanati-bck selvino-bck saronno-bck sarnico-bck sanremo-bck pineto-bck siderno-bck grado sabruzzes sasti sanzio stoscane strevise strapani slatina sfoggia donnini-bck follina-bck ameno-bck tadino-bck adrano-bck tortona-bck salcamo sterlizzi sposta spergola cropani-bck fiuggi-bck lazzaro-bck tirolo-bck rivoli-bck menfi-bck amalfi-bck dolo-bck ssalina uvsclbp01-bck uvsclbp02-bck grosseto-bck foligno-bck potenza-bck rieti-bck taranto-bck monopoli-bck carini-bck molfetta-bck bozen lerici-bck lipari-bck segrate-bck vasto-bck mantello-bck messina-bck mottola-bck abano-bck baveno-bck sjulienne palermo pescara terni pompei pomezia cesena catane sesto-bck assago-bck diano-bck giano golfo arona-bck uvsctup01 uvsctup02 brunico 10.101.109.13 ali merano-bck migliarino-bck
# csync:: migliarino-bck merano-bck
...
#
# 22/06/10: Modification des sorties pour limiter les alertes TIVOLI
...
sub tell_nagios {
    ...
    my $total_gb = sprintf "%.2f", ($total / 1024 /1024);
    my $used_gb = sprintf "%.2f", ($used / 1024 /1024);
    my $caches_gb = sprintf "%.2f", ($caches / 1024 /1024);
    my $free_gb = sprintf "%.2f", ($free / 1024 /1024);
    my $perfdata = "TOTAL=${total_gb}Gb;USED=${used_gb}Gb;FREE=${free_gb}Gb;CACHES=${caches_gb}Gb";
    
    if ($opt_f) {
      my $percent    = sprintf "%.1f", ($free / $total * 100);
      if ($percent <= $opt_c) {
          finish("CRIT=free_<${opt_c}%|$perfdata",$exit_codes{'CRITICAL'});
      }
      elsif ($percent <= $opt_w) {
          finish("RAM WARN - free < $opt_w%|$perfdata",$exit_codes{'WARNING'});
      }
      else {
          finish("RAM OK - free: $percent% ($free_gb Gb)|$perfdata",$exit_codes{'OK'});
      }
    }
    elsif ($opt_u) {
      my $percent    = sprintf "%.1f", ($used / $total * 100);
      if ($percent >= $opt_c) {
          finish("CRIT=used_>${opt_c}%|$perfdata",$exit_codes{'CRITICAL'});
      }
      elsif ($percent >= $opt_w) {
          finish("RAM WARN - used > $opt_c%|$perfdata",$exit_codes{'WARNING'});
      }
      else {
          finish("RAM OK - used: $percent% ($free_gb Gb)|$perfdata",$exit_codes{'OK'});
      }
    }
}
